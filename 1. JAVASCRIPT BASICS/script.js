...
// const greet2 = (name, timeOfDay) => {
//     console.log(`Hello ${name}, Good ${timeOfDay}!`);
// }

// greet2("Batman", "Morning");



/**********************************************************
 ** LECTURE 52:  OBJECT & "THIS" keyword*****************
 **********************************************************/
...
/**********************************************************
 ** LECTURE 53:  FUNCTION & "THIS" keyword
    LECTURE 54:  ARROW FUNCTION & "THIS" keyword
    REFER TO NOTES on "THIS" keyword
 **********************************************************/


/**********************************************************
** LECTURE 56:  VALUE TYPE VS REFERENCE TYPE
   LECTURE 57:  VALUE TYPE VS REFERENCE TYPE
   REFER TO NOTES ON VALUE TYPE VS REFERENCE TYPE
   STACK & HEAP
**********************************************************/
...
/**********************************************************
 ** LECTURE 58:  PASS BY VALUE & PASS BY REFERENCE*****************
 **********************************************************/
...
function checkIn(flightNum, passanger) {
    ...
    if (passanger.passport === 34) {
        console.log(`${passanger.name} , you are checked in for flight ${flightNum}`);
    } else {
        console.log("Sorry, you can't check in");
    }
}

/*PAY ATTENTION TO OUTPUT!!!*/
checkIn(flight, person); // Mr. Luigi , you are checked in for flight BNB999
console.log(flight); // BNB289
console.log(person); // { name: 'Mr. Luigi', passport: 34 }